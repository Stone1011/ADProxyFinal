package ad.blocker.proxy.crt;

import android.util.Log;

import ad.blocker.proxy.crt.service.bc.BouncyCastleCertGenerator;
import ad.blocker.proxy.crt.spi.CertGenerator;
import ad.blocker.proxy.crt.spi.CertGeneratorInfo;
...
public final class CertUtilsLoader {
    ...
    private static Map<String, CertGenerator> generatorMap;
...
//        Log.w("Static Block", "Static block");
        try
        {
            loadGenerator();
//            System.out.println("Load Generator Succeeds.");
        } catch (Exception e)
        {
