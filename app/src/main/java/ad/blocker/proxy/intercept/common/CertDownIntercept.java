package ad.blocker.proxy.intercept.common;
...
import ad.blocker.proxy.server.HttpProxyCACertFactory;
...
public class CertDownIntercept extends HttpProxyIntercept {
     ...
     *
     * @param certFactory The same factory as {@link ad.blocker.proxy.server.HttpProxyServer}
     *                    ({@link ad.blocker.proxy.server.HttpProxyServer#caCertFactory(HttpProxyCACertFactory)})
     ...
     *               {@link ad.blocker.proxy.server.HttpProxyServer}.
     */
